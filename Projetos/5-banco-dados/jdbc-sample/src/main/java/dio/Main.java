...
import dio.persistence.ConnectionUtil;
...
public class Main {
	...
	private final static Faker faker = new Faker(new Locale("pt", "BR")); // Java 17
	// private final static Faker faker = new Faker(Locale.of("pt", "BR")); // Java
	// 8
	...
	public static void main(String[] args) {
		...
		// insert.setName("Maria");
		// insert.setSalary(new BigDecimal("80000"));
		...
		// employee.setBirthday(OffsetDateTime.of(LocalDate.now().minusYears(faker.number().numberBetween(40,
		// 20)),
		// LocalTime.MIN, UTC));
		// return employee;
		// }).limit(10000).toList();
