...
Para acessar o banco de dados local
```
...
```
docker run --name bootcamp-bradesco-db-postgres -p 5432:5432 -e POSTGRES_PASSWORD=postgres -e POSTGRES_DB=railway -d postgres
```
